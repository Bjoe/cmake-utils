...
set(QT_QMAKE_EXECUTABLE "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/bin/qmake" CACHE FILEPATH "Qt5 qmake")
set(Qt5Core_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Core" CACHE FILEPATH "Qt5 core")
set(Qt5Concurrent_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Concurrent" CACHE FILEPATH "Qt5 concurrent")
set(Qt5Network_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Network" CACHE FILEPATH "Qt5 network")
set(Qt5OpenGL_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5OpenGL" CACHE FILEPATH "Qt5 opengl")
set(Qt5OpenGLExtensions_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5OpenGLExtensions" CACHE FILEPATH "Qt5 opengl extension")
set(Qt5PrintSupport_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5PrintSupport" CACHE FILEPATH "Qt5 print support")
set(Qt5Sql_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Sql" CACHE FILEPATH "Qt5 sql")
set(Qt5Test_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Test" CACHE FILEPATH "Qt5 test")
set(Qt5Widgets_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Widgets" CACHE FILEPATH "Qt5 widgets")
set(Qt5Xml_DIR "${BLACKBERRY_TARGET_ROOT}/${NDK_ARCH}/qt5/lib/cmake/Qt5Xml" CACHE FILEPATH "Qt5 xml")
